...
@Component({
  selector: 'app-ejercicio-escribir',
  templateUrl: './ejercicio-escribir.component.html',
  styleUrls: ['./ejercicio-escribir.component.scss']
})
export class EjercicioEscribirComponent {
  showOpciones=true;
  showEstudiar=false;
  showPracticar=false;
  showEjercicio=false;
